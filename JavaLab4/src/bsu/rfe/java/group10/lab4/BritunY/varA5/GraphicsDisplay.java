...
public class GraphicsDisplay extends JPanel{
    ...
    private boolean showAxis = true; //это типо за оси отвечает
    private boolean showMarkers = true; //а это за маркеры(точки данных)
    ...
    //Font - класс, который описывает характеристики шрифта
