...
public class MainFrame extends JFrame {
    ...
    public MainFrame(Double[] coefficients) {
        ...
        helpMenu.add(new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                JOptionPane.showMessageDialog(MainFrame.this,
                        "Автор: Бритун Юлия, группа 10",
        ...
        // Поля ввода
        JLabel labelForFrom = new JLabel("X от:");
        ...
        JLabel labelForStep = new JLabel("шаг:");
        ...
        hboxRange.add(Box.createHorizontalGlue());
        hboxRange.setPreferredSize(new Dimension(WIDTH, 40));
        ...
        hboxButtons.add(Box.createHorizontalGlue());
        hboxButtons.setPreferredSize(new Dimension(WIDTH, 40));
